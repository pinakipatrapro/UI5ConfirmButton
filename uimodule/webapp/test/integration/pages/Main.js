sap.ui.require([
  ...
  var sViewName = "pin.org.confirmButton.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of pin.org.confirmButton"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title pin.org.confirmButton"
            });
        }
      }
